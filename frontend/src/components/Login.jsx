...
export default function Login({ API_BASE_URL, onAuthSuccess, onToggleView }) {
    ...
    return (
        <div className="auth-container">
            ...
            <div className="auth-card" style={{ position: "relative", zIndex: 11 }}>
                ...
                <h2 className="auth-title">Sign in to Platform</h2>
                ...
                <form onSubmit={handleSubmit} className="auth-form">
                    ...
                    <div style={{ textAlign: "center", fontSize: "13px" }}>
                        <span style={{ color: "var(--text-secondary)" }}>New to FraudGuard? </span>
                        <button
                            type="button"
